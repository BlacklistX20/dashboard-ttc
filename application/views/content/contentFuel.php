<div class="tank-container">
   <div class="tankDaily text-center cardCustom">
      ...
      <div class="row">
         <div class="col-6">
            <h3 class="tank-label my-3"><span id="tank1Value"></span> / <span id="tank1Max">1500</span></h3>
            <div class="tank-bar">
         ...
         <div class="col-6">
            <h3 class="tank-label my-3"><span id="tank2Value"></span> / <span>1500</span></h3>
            <div class="tank-bar">
   ...
   <div class="tankmonthly text-center cardCustom">
      ...
      <div class="row">
         <div class="col-4">
            <h3 class="tank-label my-3"><span id="tank3Value">500</span> / <span>1000</span></h3>
            <div class="tank-bar">
         ...
         <div class="col-4">
            <h3 class="tank-label my-3"><span id="tank4Value">750</span> / <span>1000</span></h3>
            <div class="tank-bar">
         ...
         <div class="col-4">
            <h3 class="tank-label my-3"><span id="tank5Value">100</span> / <span>1000</span></h3>
            <div class="tank-bar">
