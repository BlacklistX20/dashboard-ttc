  ...
  <div class="tab-panels mx-3">
    <section id="lantai2" class="tab-panel">
      ...
      <div class="card text-center">
        <img src="<?= base_url() ?>asset/layout/layout_lt2.jpg" class="card-img-top" style="height: 73vh;" alt="Layout Lantai 2">
        <div class="card-footer text-dark">
          <h4 class="fw-bold">Last Update <?= $data['lantai2']; ?></h4>
        </div>
      </div>
    </section>
    <section id="lantai3" class="tab-panel">
      ...
      <div class="card text-center">
        <img src="<?= base_url() ?>asset/layout/layout_lt3.jpg" class="card-img-top" style="height: 73vh;" alt="Layout Lantai 3">
        <div class="card-footer text-dark">
          <h4 class="fw-bold">Last Update <?= $data['lantai3']; ?></h4>
        </div>
      </div>
    </section>
    <section id="lantai4" class="tab-panel">
      ...
      <div class="card text-center">
        <img src="<?= base_url() ?>asset/layout/layout_lt4.jpg" class="card-img-top" style="height: 73vh;" alt="Layout Lantai 4">
        <div class="card-footer text-dark">
          <h4 class="fw-bold">Last Update <?= $data['lantai4']; ?></h4>
        </div>
      </div>
    </section>
    <section id="lantai5" class="tab-panel">
      <form action="<?= base_url(); ?>upload/lt5" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <div class="card text-center">
          <img src="<?= base_url() ?>asset/layout/layout_lt5.jpg" class="card-img-top" style="height: 73vh;" alt="Layout Lantai 5">
          <div class="card-footer text-dark">
            <h4 class="fw-bold">Last Update <?= $data['lantai5']; ?></h4>
          </div>
        </div>
    </section>
  </div>
