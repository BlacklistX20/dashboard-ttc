...
<div class="row row-cols-xxl-6 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 mx-1">
  ...
  <div class="card-custom col">
    <a href="">
      <div class="card bg-danger text-white text-center p-3 mb-3 d-flex align-items-center justify-content-center"
        ...
        <h4>IT (<span id="potUser">0</span>)</h4>
        <h4>Core (<span id="potUser">0</span>)</h4>
        <h4>Radio (<span id="potUser">0</span>)</h4>
        <h4>Transmisi (<span id="potUser">0</span>)</h4>
      </div>
    </a>
  </div>
  <div class="card-custom col">
  ...
  <div class="card-custom col">
    <a href="">
      <div class="card bg-danger text-white text-center p-3 mb-3 d-flex align-items-center justify-content-center"
        style="height: 40vh;">
        <img class="ico mb-3" src="<?= base_url() ?>asset\src\img\cctv.png" alt="ICON">
  ...
  <div class="card-custom col">
    <a href="">
      <div class="card bg-danger text-white text-center p-3 mb-3 d-flex align-items-center justify-content-center"
        style="height: 40vh;">
        <img class="ico mb-3" src="<?= base_url() ?>asset\src\img\pump.png" alt="ICON">
